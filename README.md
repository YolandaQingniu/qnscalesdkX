...
* 在你的module的根目录下的**build.gradle**添加依赖
	```
	<!--这里的版本号，2.7.14 可以指定为任意release版本-->
	<!--如果希望一直使用最新版本可以替换 2.7.14 master-SNAPSHOT -->
	dependencies {
	        ...
	        compile 'com.github.YolandaQingniu:qnscalesdkX:2.7.14'
	}
	```
	
### Android Studio 本地依赖
* 下载最新的[jar和so库](https://github.com/YolandaQingniu/qnscalesdkX/releases/download/2.7.14/qnsdkX-2.7.14-Android.zip)，导入下载的`jar和so库`
